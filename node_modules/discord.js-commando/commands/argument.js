...
class Argument {
  ...
  description: stripIndents`
				${empty ? this.prompt : valid ? valid : `Geçersiz seçim lütfen bir ${this.label}. giriniz.`}`,
       
    footer: {
    text: `${oneLine`
	Komutu iptal etmek için \`iptal\` yazın.
	${wait ? `Otomatik olarak ${this.wait} saniye sonra iptal olucak.` : ''}`
    }`
     }
}
}));
