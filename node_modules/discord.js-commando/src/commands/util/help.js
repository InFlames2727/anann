...
module.exports = class HelpCommand extends Command {
	constructor(client) {
		super(client, {
			...
			group: 'ana',
			memberName: 'yardım',
			aliases: ['komutlar','help','commands','yardim','y'],
	...
	async run(msg, args) {
		...
		if(args.command && !showAll) {
			...
			try {
				...
				.addBlankField(true)
				.addField('Müzik Komutları' , '**oynat**: İstediğiniz şarkıyı oynatır.\n**dur**: Çalınan şarkıyı durdurur\n**geç**: Çalan şarkıyı geçmenizi sağlar.\n**ses**: Sesi açar\n**oynatma-listesi**: Şarkı listesinisi gösterir.')
				.setFooter('© ' + (new Date()).getFullYear() + ' Vegas Bot', this.client.user.avatarURL);
